...
// Selling price must be strictly positive — a cleared PriceManager field used
// to save price 0 (CHECK allows >= 0) and list the product at Rs. 0.
const positivePrice = Joi.number().greater(0).max(999999.99).messages({
