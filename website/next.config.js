...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      // Browsers and some crawlers probe /favicon.ico directly. There is no
      // static file there (the favicon is generated by app/icon.tsx), so serve
      // that same square PNG instead of returning a 404.
      {
        source: '/favicon.ico',
        destination: '/icon',
      },
