...
const navItems: NavItem[] = [
  ...
  { path: '/admin/price-manager', label: 'Price Manager', icon: <Tag className="w-5 h-5" /> },
  { path: '/admin/stock', label: 'Stock Management', icon: <Boxes className="w-5 h-5" /> },
  { path: '/admin/expenses', label: 'Expenses', icon: <Receipt className="w-5 h-5" /> },
  { path: '/admin/workers', label: 'Workers', icon: <UserCog className="w-5 h-5" /> },
  { path: '/admin/profit', label: 'Profit', icon: <PieChart className="w-5 h-5" /> },
